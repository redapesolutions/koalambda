...
var arrayFilter = __webpack_require__(118),
    stubArray = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kompose__ = __webpack_require__(46);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "kompose", function() { return __WEBPACK_IMPORTED_MODULE_0__kompose__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user__ = __webpack_require__(48);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "withUserId", function() { return __WEBPACK_IMPORTED_MODULE_1__user__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http__ = __webpack_require__(98);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "jsonBody", function() { return __WEBPACK_IMPORTED_MODULE_2__http__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "HTTP_ERROR_CODES", function() { return __WEBPACK_IMPORTED_MODULE_2__http__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "standardHttpResponse", function() { return __WEBPACK_IMPORTED_MODULE_2__http__["c"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lambda__ = __webpack_require__(100);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "contextBased", function() { return __WEBPACK_IMPORTED_MODULE_3__lambda__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "callbackBased", function() { return __WEBPACK_IMPORTED_MODULE_3__lambda__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__response__ = __webpack_require__(101);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "fixedResponseBody", function() { return __WEBPACK_IMPORTED_MODULE_4__response__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__manipulation__ = __webpack_require__(139);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapPropertyDown", function() { return __WEBPACK_IMPORTED_MODULE_5__manipulation__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "mapPropertyUp", function() { return __WEBPACK_IMPORTED_MODULE_5__manipulation__["b"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa_compose__ = __webpack_require__(47);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_each__ = __webpack_require__(49);
...
const withUserId = (ctx, next) => __awaiter(this, void 0, void 0, function* () {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = withUserId;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ERROR_CODES; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isNumber__ = __webpack_require__(99);
...
(function (ERROR_CODES) {
    ERROR_CODES[ERROR_CODES["JSON_PARSING_ERROR"] = 100] = "JSON_PARSING_ERROR";
    ERROR_CODES[ERROR_CODES["MISSING_BODY"] = 101] = "MISSING_BODY";
...
/* harmony export (immutable) */ __webpack_exports__["b"] = jsonBody;
...
const _makeResponse = (body, statusCode = 200, cors = true, headers = {}) => {
    ...
    if (cors) {
        resp.headers = Object.assign(resp.headers, Object.assign({ "Access-Control-Allow-Origin": "*" }, headers));
    }
    return resp;
};
/* unused harmony export _makeResponse */

const _callbackBasedHttpHandleError = err => {
    let message, code = 400, internalCode = 0;
...
/* unused harmony export _callbackBasedHttpHandleError */
...
/* unused harmony export makeResponse */

const makeError = (message, statusCode = 400, cors = true, internalErrorCode = 0) => {
...
/* harmony export (immutable) */ __webpack_exports__["c"] = standardHttpResponse;
...
/* unused harmony export doNotWaitForBgProcessesToFinish */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__ = __webpack_require__(102);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = fixedResponseBody;
...
var copyObject = __webpack_require__(12),
    getSymbolsIn = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_get__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_get___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_get__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_set__ = __webpack_require__(140);
...
const mapPropertyDown = (source, target, defaultValue) => (ctx, next) => __awaiter(this, void 0, void 0, function* () {
    ctx.state[target] = __WEBPACK_IMPORTED_MODULE_0_lodash_get___default()(ctx.state, source, defaultValue || null);
    next && (yield next());
});
/* harmony export (immutable) */ __webpack_exports__["a"] = mapPropertyDown;

const mapPropertyUp = (source, target, defaultValue) => (ctx, next) => __awaiter(this, void 0, void 0, function* () {
    next && (yield next());
    ctx.state[target] = __WEBPACK_IMPORTED_MODULE_0_lodash_get___default()(ctx.state, source, defaultValue || null);
});
/* harmony export (immutable) */ __webpack_exports__["b"] = mapPropertyUp;

const putInState = (variableName) => __awaiter(this, void 0, void 0, function* () {
    return (ctx, next) => __awaiter(this, void 0, void 0, function* () {
        let value = __WEBPACK_IMPORTED_MODULE_0_lodash_get___default()(ctx.event, `${variableName}`);
        __WEBPACK_IMPORTED_MODULE_1_lodash_set___default()(ctx.state, `${variableName}`, value);
        next && (yield next());
    });
});
/* unused harmony export putInState */

const filter = (variableName, compareFunction) => __awaiter(this, void 0, void 0, function* () {
    return (ctx, next) => __awaiter(this, void 0, void 0, function* () {
        let array = __WEBPACK_IMPORTED_MODULE_0_lodash_get___default()(ctx.state, `${variableName}`);
        if (!__WEBPACK_IMPORTED_MODULE_2_lodash_isArray___default()(array))
            throw Error('Variable should be an array');
        __WEBPACK_IMPORTED_MODULE_1_lodash_set___default()(ctx.state, `${variableName}`, array.filter(compareFunction));
        next && (yield next());
    });
});
